...
<head>
  ...
  <title>Academia Rosbe - <?php echo $title;?></title>
  <!-- CSS only -->
      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <a href="#" class="logo">
              <img src="assets/images/logo5.png" alt="EduWell Template" width="100" height="80"/>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              ...
              <li class="scroll-to-section">
                <a href="#services">Acerda de</a>
              </li>
              <li class="scroll-to-section">
                <a href="#courses">Cursos</a>
              </li>
              <li class="scroll-to-section">
                <a href="#testimonials">Maestros</a>
              </li>
              <li class="scroll-to-section">
                <a href="#contact-section">Contactanos</a>
              </li>
            </ul>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            <h6>Academia ROSBE</h6>
            <h2>Comienza tú educación <em>HOY!</em></h2>
            <div class="main-button-gradient">
              <div class="scroll-to-section">
                <a href="#contact-section">Unete ahora!</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            ...
            <h4>¿Qué es lo que puedes <em>Arender</em>?</h4>
            <p>Descripcion de los cursos</p>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="naccs">
                      ...
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p>
                            ...
                            <a rel="nofollow" href="https://www.toocss.com/" target="_blank">TooCSS website</a>
                            for latest listing of HTML templates and a variety
                            of useful templates. <br /><br />You just need to
                            go and visit that website right now. IF you have
                            any suggestion or comment about this template, you
                            can feel free to go to contact page for our email
                            address.
                          </p>
                          <span>36 Hours</span>
                          <span>4 Weeks</span>
                      ...
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p>
                            ...
                            from us.<br /><br />There are some unethical
                            people on this world copied and reposted our
                            templates without any permission from us. Their
                            Karma will hit them really hard. Yeah!
                          </p>
                          <span>48 Hours</span>
                          <span>6 Weeks</span>
                      ...
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p>
                            ...
                            organic seitan.<br /><br />Kogi VHS freegan
                            bicycle rights try-hard green juice probably
                            haven't heard of them cliche la croix af
                            chillwave.
                          </p>
                          <span>28 Hours</span>
                          <span>4 Weeks</span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            <h6>Testimonios</h6>
            <h4>¿Qué es lo que ellos<em> Piensan?</em></h4>
          </div>
        </div>
        <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-lg-8">
          <div id="map">
            ...
            <iframe src="https://maps.google.com/maps?q=fresnillo%20de%20las%20limas%203%20arboledas&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="420px" frameborder="0" style="
                  border: 0;
                  border-radius: 15px;
                  position: relative;
                  z-index: 2;
